...
public class UniqueValues {
     ...
     */
    public static ArrayList<Integer> makeUnique_ArrayList(
     ...
     * 
     * @note **IMPORTANT** Ideally this method should not have any loops. You
     *       should be able to implement the whole method only in 3 lines.
     * 
     * @see HashSet.addAll
     * 
     * @param list The list of values from where unique numbers are to be
    ...
    public static ArrayList<Integer> makeUnique_Set(ArrayList<Integer> list) {
        ...
        set.addAll(list);
        // line 3: Creating a new ArrayList and passing the HashSet object to
        // the
     ...
     *       thereby providing a O(n) implementation.
     * 
     * @note You will need a loop to add entries to the HashMap. For the key you
     *       can use the elements inside the given list, and for the values you
     *       can use the boolean value true for all elements -> <Integer,
     *       Boolean>
     * 
     * @note You should only return the keys as an arrayList. Check out the
     *       keySet method. \see HashMap.keySet()
     * 
     * @param list The list of values from where unique numbers are to be
     *             returned.
     * 
    ...
    public static ArrayList<Integer> makeUnique_Map(ArrayList<Integer> list) {
        ...
        // You can use each element as a key, and the boolean value true as the
        // value:
        // <key, value> == <Integer, Boolean> == < an element of the list, true>
        for (int a : list) {
            map.put(a, true);
        }
        // line 5: Creating a new ArrayList and passing only the keys from the
        // HashMap object
        // (check out the keySet() method) to the constructor to create a new
        // arrayList
    ...
    /**
     * Using ListIterator, go through the list and add them up elements and
     * return the sum.
     * 
    ...
    public static long sum(ArrayList<Integer> list) {
        ...
        long sum = 0;
        // line 3, 4, 5: using a while loop to go through the elements using the
        // Iterator object
