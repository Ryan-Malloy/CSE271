...
public class Rhombus extends Shape {
    ...
    public Polygon getVertices() {
        ...
        vertices.addPoint(getXpos() + getWidth(), getYpos() + getHeight() / 2);
        vertices.addPoint(getXpos() + getWidth() / 2, getYpos() + getHeight());
        vertices.addPoint(getXpos(), getYpos() + getHeight() / 2);
